...
import {
	...
	HoverCardContent,
	HoverCardTrigger,
} from "@mdit/ui/components/hover-card"
import {
	InputGroup,
	InputGroupAddon,
	InputGroupButton,
	InputGroupTextarea,
} from "@mdit/ui/components/input-group"
import {
	Select,
	SelectContent,
	SelectItem,
...
import { Spinner } from "@mdit/ui/components/spinner"
import {
	Tooltip,
	TooltipContent,
	TooltipTrigger,
...
export const PromptInputActionAddScreenshot = ({
	...
	return (
		<DropdownMenuItem {...props} onSelect={handleSelect}>
			<IconScreenshot className="mr-2 size-4" />
			{label}
		</DropdownMenuItem>
	)
}
