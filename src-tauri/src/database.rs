...
fn read_frontmatter(path: PathBuf) -> Result<JsonValue, String> {
...
#[tauri::command]
pub async fn get_file_frontmatter(path: String) -> Result<JsonValue, String> {
    tauri::async_runtime::spawn_blocking(move || read_frontmatter(PathBuf::from(path)))
        .await
